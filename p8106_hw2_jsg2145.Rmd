...
The MARS model predicts a tuition of `r pred.earth` and the GAM model predicts a tuition of `r pred.gam`. Because the MARS model has a lower RMSE it is appropriate to accept this model and predict a tuition of `r pred.earth`.